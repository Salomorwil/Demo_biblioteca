package com.example.demo_bliblioteca.repository;
...
public class LibroRepository {
    ...
    public Libro actualizar(Libro lib){
        ...
        Libro libro1 = new Libro(id,lib.getIsbn(),lib.getTitulo(),lib.getEditorial(),lib.getFechaPublicacion(),lib.getAutor());
